...
var u=d[g],w=u.getAttribute("data-src")||u.getAttribute("src"),h=u.getAttribute("data-type");
if(w&&!w.isGif()&&0!=w.indexOf("data:")){
for(;-1!=w.indexOf("?tp=webp");)w=w.replace("?tp=webp","");
u.dataset&&u.dataset.s&&w.isCDN()&&(w=w.replace(/\/640$/,"/0"),w=w.replace(/\/640\?/,"/0?")),
w.isCDN()&&(w=n.addParam(w,"wxfrom","3",!0)),w=e.is_https_res?w.http2https():w.https2http(),
h&&(w=n.addParam(w,"wxtype",h,!0)),a.push(w),"1"!=u.getAttribute("data-nopreviewclick")&&!function(e){
i.on(u,"click",function(i){
...
var s=window.getComputedStyle(r,null),g=parseInt(s.getPropertyValue("opacity")),l=s.getPropertyValue("filter"),u=s.getPropertyValue("visibility"),w=s.mixBlendMode;
if(1!=g||"visible"!=u||l.indexOf("opacity")>=0||l.indexOf("blur")>=0||w&&"normal"!=w){
d=!1;
break;
}
...
}(w),u.removeAttribute("data-nopreviewclick");
}
}
if(c){
...
});define("appmsg/async.js",["biz_common/utils/string/html.js","appmsg/comment_utils.js","pages/create_txv.js","pages/video_ctrl.js","biz_common/utils/url/parse.js","biz_common/dom/class.js","appmsg/img_copyright_tpl.html.js","appmsg/appmsgext.js","appmsg/share_tpl.html.js","biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_common/tmpl.js","biz_wap/utils/storage.js","appmsg/log.js","rt/appmsg/getappmsgext.rt.js","a/a_utils.js","biz_wap/utils/mmversion.js","pages/version4video.js","appmsg/like.js","appmsg/reward_entry.js","appmsg/iframe.js","appmsg/more_read.js"],function(e,t,r,i){
"use strict";
function n(){
for(var t=document.getElementsByTagName("iframe"),r=[],i=0,n=t.length;n>i;++i)r.push(t[i]);
t=null;
var d=document.getElementById("js_content"),o=d.offsetWidth,_=o/u.getRatio();
window.logs.video_cnt=0;
for(var i=0,n=r.length;n>i;++i){
var s=r[i],m=s.getAttribute("data-src")||"",l=s.getAttribute("src")||m;
if(l){
var c=e("pages/version4video.js");
if(0==l.indexOf("http://z.weishi.com/weixin/player.html"))l=l.replace(/width=\d+/g,"width="+o),
l=l.replace(/height=\d+/g,"height="+_),s.width=o,s.height=_,s.style.setProperty&&(s.style.setProperty("width",o+"px","important"),
s.style.setProperty("height",_+"px","important")),s.setAttribute("src",l),window.__addIdKeyReport&&window.__addIdKeyReport("28307",10),
window.logs.video_cnt++;else if(/http(s)*\:\/\/v\.qq\.com\/iframe\/(preview|player)\.html\?/.test(l)){
if(!c.isShowMpVideo()){
var p;
p=a(b?s:s),p&&A.push(p),"function"==typeof window.__addIdKeyReport&&(window.__addIdKeyReport("28307",10),
...
var _=e.parentNode;
return _?(_.lastChild===e?_.appendChild(o):_.insertBefore(o,e.nextSibling),w.createTxVideo({
containerId:o.id,
vid:r,
width:i,
height:n,
...
for(var _=document.getElementsByTagName("img"),a=0,d=_.length;d>a;a++){
var o=_[a],s=o.getAttribute("data-src")||o.getAttribute("data-backsrc")||"";
if(t[s]){
var m=document.createElement("div");
m.innerHTML=I.tmpl(h,t[s]);
{
var l=m.children[0],c=o.parentNode,p=c.insertBefore(l,o),w=p.children[0];
(function(e,t){
...
{
var n=document.getElementById("js_read_area3"),a=document.getElementById("like3"),d=document.getElementById("like_old"),o=document.getElementById("likeNum3"),_=document.getElementById("likeNum_old"),s=document.getElementById("readNum3");
document.getElementById("js_like_title");
}
if(!(n&&a&&o&&s))return;
var l,w,u=e("appmsg/like.js");
1==appmsg_like_type?(l=d,w=_):(l=a,w=o),r.liked=window.is_temp_url?window.liked:r.liked,
u.showReadNum({
show:!0,
readAreaDom:n,
readNumDom:s,
...
permission:r.like_disabled||2!==appmsg_like_type?0:1,
recommend:r.liked?1:0
},function(){}),r.like_disabled||(u.showLikeNum({
show:!0,
likeAreaDom:l,
likeNumDom:w,
liked:r.liked,
...
var g=document.getElementById("js_share_appmsg");
t.share_redirect_url&&g&&(window._share_redirect_url=t.share_redirect_url,g.innerHTML=I.tmpl(v,{
url:t.share_redirect_url
})),p.initCommentByExtData(t),B.setBackgroundClass();
var h=document.getElementById("js_author_name");
t.reward_entrance_enable_for_preview||(-1!=f.indexOf("WindowsWechat")||-1==f.indexOf("MicroMessenger")||z.isInMiniProgram?z.isInMiniProgram&&h&&k.removeClass(h,"rich_media_meta_link"):(c=e("appmsg/reward_entry.js"),
c.handle(t.reward,m()),h&&t.reward.rewardsn&&t.reward.timestamp&&(h.setAttribute("data-rewardsn",t.reward.rewardsn),
h.setAttribute("data-timestamp",t.reward.timestamp),h.setAttribute("data-canreward",t.reward.can_reward)),
h&&!t.reward.can_reward&&k.removeClass(h,"rich_media_meta_link"))),1!=t.reward_entrance_enable_for_preview||z.isInMiniProgram?(1==t.reward_entrance_enable_for_preview||z.isInMiniProgram)&&h&&k.removeClass(h,"rich_media_meta_link"):author_id?(document.getElementById("js_preview_reward_author")&&(document.getElementById("js_preview_reward_author").style.display="block"),
...
document.getElementById("js_preview_reward_link_text").innerText="喜欢作者",j.on(document.getElementById("js_preview_reward_author_link"),"tap",function(e){
e.preventDefault(),i("预览状态下无法操作。");
})):z.isAndroid&&(document.getElementById("js_preview_reward_author")&&(document.getElementById("js_preview_reward_author").style.display="block"),
t.reward_wording&&document.getElementById("js_preview_reward_author_wording")&&(document.getElementById("js_preview_reward_author_wording").innerText=t.reward_wording,
document.getElementById("js_preview_reward_author_wording").style.display="block"),
document.getElementById("js_preview_reward_author_name").style.display="none",j.on(document.getElementById("js_preview_reward_author_link"),"tap",function(e){
e.preventDefault(),i("预览状态下无法操作。");
}));
var y=document.getElementById("js_cmt_container");
1==t.comment_entrance_enable_for_preview&&window.is_temp_url&&y&&(y.style.display="block"),
...
e.preventDefault(),i("预览状态下无法操作。");
})),t.comment_enabled&&y&&(y.style.display="block");
}
function s(){
var t=0;
y.getData({
...
o(t),t.ret)return;
var r=document.getElementById("js_more_read_area");
r&&t&&t.more_read_list&&t.more_read_list.length&&e("appmsg/more_read.js")(r,t.more_read_list),
window.wx_user_can_reward=t.user_can_reward,_({
...
var n=new Image;
return n.src=("http://mp.weixin.qq.com/mp/jsreport?1=1&key=1&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key1]"+encodeURIComponent(i.toString())+"&r="+Math.random()).substr(0,1024),
...
try{
var t=document.getElementById("img-content").getBoundingClientRect();
t.width&&(e=t.width);
}catch(r){}
var i=36,n=Math.floor(.8*e/i);
return document.getElementById("js_reward_inner")&&(document.getElementById("js_reward_inner").style.width=n*i+"px"),
m=function(){
return n;
},n;
}
e("biz_common/utils/string/html.js");
var c,p=e("appmsg/comment_utils.js"),w=e("pages/create_txv.js"),u=e("pages/video_ctrl.js"),g=e("biz_common/utils/url/parse.js"),h=(e("biz_common/dom/class.js"),
e("appmsg/img_copyright_tpl.html.js")),y=e("appmsg/appmsgext.js"),v=e("appmsg/share_tpl.html.js"),f=navigator.userAgent,b=-1!=f.indexOf("MicroMessenger"),j=(-1!=navigator.userAgent.indexOf("WindowsWechat"),
e("biz_common/dom/event.js")),k=(e("biz_wap/utils/ajax.js"),e("biz_common/dom/class.js")),x=e("biz_wap/jsapi/core.js"),I=e("biz_common/tmpl.js"),E=(e("biz_wap/utils/storage.js"),
e("appmsg/log.js")),B=(e("rt/appmsg/getappmsgext.rt.js"),e("a/a_utils.js")),z=e("biz_wap/utils/mmversion.js"),A=[];
n(),s();
...
define("a/mpAdAsync.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js","a/a.js","a/a_utils.js"],function(e){
"use strict";
function i(e){
for(var i=window.location.href,t=i.indexOf("?"),a=i.substr(t+1),d=a.split("&"),n=0;n<d.length;n++){
var o=d[n].split("=");
...
function t(e,t,d){
var p=[],g=m.checkNeedAds(),w=g.is_need_ad,l=g.both_ad,f=i("mock"),v=i("rtx"),_="/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",y="/mp/getappmsgad";
t=t||{},e||(e=[]);
for(var u=0;u<e.length;u++)0==e[u].indexOf("wxv")&&p.push(e[u]);
(f&&"-1"!=f||v)&&(console.info("[广告走mock系统] mockId",f,"rtx",v),y=_),console.info("[广告发送请求] 是否拉取广告",w),
s({
url:y+"?f=json&mockid="+f+"&rtx="+v,
data:{
r:Math.random(),
__biz:biz,
...
sn:sn,
idx:idx,
scene:t.scene||window.scene,
title:t.title||encodeURIComponent(window.msg_title.htmlDecode()),
ct:t.ct||window.ct,
abtest_cookie:t.abtest_cookie||window.abtest_cookie||"",
devicetype:"string"==typeof t.devicetype?t.devicetype:window.devicetype.htmlDecode(),
version:"string"==typeof t.version?t.devicetype:window.clientversion.htmlDecode(),
is_need_ad:w,
both_ad:l,
send_time:t.send_time||window.send_time||"",
msg_daily_idx:t.msg_daily_idx||window.msg_daily_idx,
pass_ticket:pass_ticket,
is_temp_url:window.is_temp_url||0,
item_show_type:item_show_type,
tmp_version:1,
vid_list:JSON.stringify(p)
},
type:"POST",
dataType:"json",
rtId:"27613",
...
async:!0,
success:function(e){
o("[Appmsg] success get async ad data"),console.info("[广告响应请求]",e);
var i;
if(window.can_see_complaint=e.can_see_complaint,m.afterGetAdData(g,e),c.setBackgroundClass(),
0==w?(i=g._adInfo,i||(i={
advertisement_num:0
})):i=e,i.advertisement_info&&0!=i.advertisement_info.length)try{
if(o("[Appmsg] success get async ad data, async data is: "+JSON.stringify(i)),window.originalVideoAdFramesAdData={},
i.advertisement_info)for(var t=0;t<i.advertisement_info.length;t++)i.advertisement_info[t].cdg_appid=i.appid,
i.advertisement_info[t].vid&&(window.originalVideoAdFramesAdData[i.advertisement_info[t].vid]=n(i.advertisement_info[t]));
if(window.originalVideoAdFramesUnsetList&&0!=window.originalVideoAdFramesUnsetList.length)for(var s,r=document.getElementsByTagName("iframe"),t=0;t<window.originalVideoAdFramesUnsetList.length;t++)for(var l=0;l<r.length;l++)if(r[l].dataset&&r[l].dataset.mpvid==window.originalVideoAdFramesUnsetList[t]){
window.originalVideoAdFramesAdData[r[l].dataset.mpvid]||(window.originalVideoAdFramesAdData[r[l].dataset.mpvid]={}),
s=window.originalVideoAdFramesAdData[r[l].dataset.mpvid],r[l].contentWindow.postMessage({
action:"receiveOriginalVideoData",
vid:window.originalVideoAdFramesUnsetList[t],
adData:s
},"*");
break;
}
p[0]&&window.postMessage({
action:"receiveOriginalVideoData",
vid:p[0],
adData:window.originalVideoAdFramesAdData[p[0]]
},"*");
}catch(f){}else o("[Appmsg] success get async ad data, async data is empty"),a(p);
d&&d();
},
error:function(){
o("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),a(p);
}
});
}
function a(e){
var i,t=document.getElementsByTagName("iframe");
if(window.originalVideoAdFramesAdData={},window.originalVideoAdFramesUnsetList){
for(var a=0;a<window.originalVideoAdFramesUnsetList.length;a++)for(var d=0;d<t.length;d++)if(t[d].dataset&&t[d].dataset.mpvid==window.originalVideoAdFramesUnsetList[a]){
window.originalVideoAdFramesAdData[t[d].dataset.mpvid]||(window.originalVideoAdFramesAdData[t[d].dataset.mpvid]={}),
i=window.originalVideoAdFramesAdData[t[d].dataset.mpvid],t[d].contentWindow.postMessage({
action:"receiveOriginalVideoData",
...
var a=e[t],o="undefined"==typeof a?"undefined":_typeof(a);
a="string"==o?a.htmlDecode():a,"object"==o&&(a="[object Array]"==Object.prototype.toString.call(a)?d(a):n(a)),
i.push(a);
}
return i;
}
...
var o=e("appmsg/log.js"),s=e("biz_wap/utils/ajax.js"),r=e("rt/appmsg/getappmsgext.rt.js"),m=e("a/a.js"),c=e("a/a_utils.js");
return{
getAdData:t
};
...
"use strict";
function o(i){
var o=i.link,t=i.action_type,e=o.split("?").pop();
if(e=e.split("#").shift(),""!=e){
var p=i.reportVid||window.reportVid,d=i.reportMid||window.reportMid,r=i.reportVoiceid||window.reportVoiceid,a=i.reportWeappid||window.reportWeappid,w=[],_=[],u=[];
if("undefined"==typeof i.ori_status_arr||"undefined"==typeof i.hit_bizuin_arr)for(var c=s.getVideoInfo(),h=0;h<p.length;h++){
var f=p[h];
w.push(c[f]&&"undefined"!=typeof c[f].ori_status?c[f].ori_status:0),_.push(c[f]&&"undefined"!=typeof c[f].hit_bizuin?c[f].hit_bizuin:""),
u.push(c[f]&&"undefined"!=typeof c[f].hit_vid?c[f].hit_vid:"");
}else w=i.ori_status_arr,_=i.hit_bizuin_arr,u=i.hit_vid_arr;
var m=[e,"action=share","action_type="+t,"scene="+(i.source||window.source),"ascene="+(i.ascene||window.ascene||-1),"req_id="+(i.req_id||window.req_id||""),"vid="+("undefined"!=typeof p?p.join(";"):""),"musicid="+("undefined"!=typeof d?d.join(";"):""),"voiceid="+("undefined"!=typeof r?r.join(";"):""),"weappid="+("undefined"!=typeof a?a.join(";"):""),"item_show_type="+(i.item_show_type||window.item_show_type||0),"ori_status_arr="+w.join(";"),"hit_bizuin="+_.join(";"),"hit_vid_arr="+u.join(";"),"top_stories="+(i.top_stories||0),"content_url="+encodeURIComponent(window.location.href)];
...
var n=i("biz_wap/utils/ajax.js"),s=i("pages/video_communicate_adaptor.js");
return{
shareReport:o,
profileReport:t,
hotspotReport:e
