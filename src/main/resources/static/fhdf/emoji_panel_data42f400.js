...
try{
h._debug=window.parent.window.location.href.indexOf("&_debug=1")>0?!0:!1;
}catch(c){
h._debug=!1;
}
var p=3e3;
...
},f=(navigator.userAgent,function(){
return!0;
}()),v=function(){
return!!d.browser.M1;
}(),m=function(e,t){
...
},w=!d.canSupportVideo,T=function(e){
var t=$(e.container);
...
.1>=n&&(i.needToFit=!0,m("objectFit","fill")&&(i.supportObjectFit=!0,e.videoFit=!0));
}
...
status:"init",
subStatus:"init"
},e._mustHideFullScreen=v,e.display=e.autoHide?"none":"block",e.ad_muted_btn=e.ad_muted_btn||!1;
var a=l.tmpl(s,e);
t.append(a);
...
if(r.setAttribute("origin_src",u),w)return o.find(".js_btn_play").attr("href",u).show(),
...
if(t.__forcePause===!0)return void g(t.id+":timeupdate __forcePause return");
if(t.__hasBeginPlay&&!t.__canplay)return t.showLoading(),!1;
a=t.video,null!=t.__replaySec&&(g(t.id+":timeupdate __replaySec"),a.pause(),a.currentTime=t.__replaySec,
...
g("player inner isend:"+t.isEnd()),t.isEnd()&&(t.changeStatus({
status:"end",
subStatus:""
...
t.showLoading(),t.showCover(),a.pause(),a.src=e,a.load(),a.play(),g(t.id+":stalled"));
}
}),e.on("seeked",function(){
t.__onTouch||(t.changeStatus({
status:"loading",
subStatus:"seeked"
}),a.play()),t.__seeking=!1,g("video seeked event");
}),e.off("seeking").on("seeking",function(){
g("seeking,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay&&(t.changeStatus({
status:"loading",
subStatus:"seeking"
}),t.__seeking=!0,t.showLoading());
}),e.off("waiting").on("waiting",function(){
if(g("waiting,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay){
t.changeStatus({
status:"loading",
subStatus:"waiting"
...
var i=a.src;
t.showLoading(),t.showCover(),a.pause(),a.src=i,o++,a.load(),a.play(),g(t.id+":waitingHandlerTimer");
}
}
},1e4)),t._trigger("waiting");
}
}),e.off("play playing").on("play playing",function(e){
return t.__forcePause===!0?void g(t.id+":play playing __forcePause return"):(t.changeStatus({
status:"play",
subStatus:e.type
}),setTimeout(function(){
t.adVideoStatus="play";
},10),g(t.id+":play playing"),n.removeClass("switch_on"),n.addClass("switch_off"),
t._hidePlayControllBar(),t.__startCountTime(),void t._trigger("play"));
}),e.off("pause").on("pause",function(){
g(t.id+":video pause event"),t.changeStatus({
status:"pause",
subStatus:""
...
t.hideLoading(),t.__isInFullScreen=!1),g("fullscreenchange state:"+t.__isInFullScreen+"; event type:"+e.type),
_.broadcastMessage({
...
function e(){
if(w)return location.href=i.opt.src,!1;
if(i.changeStatus({
status:"loading",
subStatus:"preload"
}),a){
...
o.find(".js_page_video")),v=o.find(".js_full_mask"),m=o.find(".js_video_pause_controll"),y=o.find(".js_full_screen_control"),T=o.find(".js_loading");
...
return i.isInFullScreen()?f&&i.exitFullScreen():f&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=28307_56_1&r="+Math.random(),
...
(d||u>=.5)&&(this.progressBarSeekData.dragTime=s,g("_pointerMoveHandler set currentTime, dragTime:"+this.progressBarSeekData.dragTime+" currentTime:"+this.video.currentTime),
...
this.progressBarSeekData=null,g("_pointerUpHandler dragTime:"+i+" currentTime:"+this.video.currentTime),
setTimeout(function(){
...
this.container.find(".js_now_play_time").text(y(e));
},
...
t.status=e.status,t.subStatus=e.subStatus,g("statusChange, preStatus:"+i+"; status:"+t.status+"; preSubStatus:"+n+"; subStatus:"+t.subStatus),
_.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
...
this.waitingHandlerTimer=null),e.pause(),g(this.id+":pause function"));
},
...
paramsPreHandler:function(t){
return t.title=t.avatarTitle,t.desc=t.hint_txt,t.biz_info.is_subscribed&&(t.btn_text="查看"),
t;
},
renderData:{
isWxapp:!1
...
"进入应用"==t.btn_text&&(t.btn_text="进入")),t.biz_info.is_subscribed&&(t.btn_text="查看"),
t;
}
},
355:{
...
paramsPreHandler:function(t){
var _=t.shop_image;
return t.shop_image.length>0&&(_=_[0]),t.banner=_.image_url,t.title=t.hint_txt,t.tags=_.mp_tags,
t;
}
}
};
